...
//make "tzDateInstance instanceof Date" return true
   ...
   *    | function(function(method, url, data, headers)}`
     ...
     * on the `ngMockE2E` and your application module and defines the fake backend:
     *
     * ```js
 ...
 *    | function(function(method, url, data, headers)}`
    ...
    if (window.jasmine || window.mocha) {
         ...
         *
         * @param {...(string|Function|Object)} fns any number of module which are represented as string
         *        aliases or as anonymous module initialization functions. The module are used to
         *        configure the injector. The 'ng' and 'ngMock' module are automatically loaded. If an
   ...
   *
   *     // You need to load module that you want to test,
