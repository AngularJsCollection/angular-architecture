...
(function() {
    ...
    ocLazyLoad.provider('$ocLazyLoad', ['$controllerProvider', '$provide', '$compileProvider', '$filterProvider', '$injector', '$animateProvider',
        function($controllerProvider, $provide, $compileProvider, $filterProvider, $injector, $animateProvider) {
            ...
            // Let's get the list of loaded module & components
            ...
            this.$get = ['$log', '$q', '$templateCache', '$http', '$rootElement', '$rootScope', '$cacheFactory', '$interval', function($log, $q, $templateCache, $http, $rootElement, $rootScope, $cacheFactory, $interval) {
                ...
                return {
                    ...
                    /**
                     * Load a module or a list of module into Angular
            ...
            this.config = function(config) {
                ...
                // If we want to define module configs
    ...
    /**
     * Get the list of required module/services/... for this module
     * @param module
     * @returns {Array}
     */
    ...
    /**
     * Get the list of existing registered module
     * @param element
     */
